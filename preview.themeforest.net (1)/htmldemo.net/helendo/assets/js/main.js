...
function(t) {
    "use strict";
    var n, i, s, e = t(window),
        o = e.width(),
        a = t(".header-sticky");
    t("html"), t("body");
    e.on("load", function() {
        t(".bg-img").each(function(n, i) {
            var s = t(i),
                e = s.data("bg");
            s.css("background", "url(" + e + ")")
        })
    }), e.on("scroll", function() {
        var t = e.scrollTop(),
            n = a.height();
        o >= 320 && (t < n ? a.removeClass("is-sticky") : a.addClass("is-sticky"))
    }), n = t("#scroll-top"), i = 0, (s = t(window)).on("scroll", function() {
        var e = t(this).scrollTop();
        e > i ? n.removeClass("show") : s.scrollTop() > 200 ? n.addClass("show") : n.removeClass("show"), i = e
    }), n.on("click", function(n) {
        t("html, body").animate({
            scrollTop: 0
        }, 600), n.preventDefault()
    });
    var l = t(".navigation-menu--onepage").height() - 60;
